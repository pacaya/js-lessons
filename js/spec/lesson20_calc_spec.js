describe("calculator", function() {
  ...
  it("sum should support negative number at last position", function () {
    const result = sum("1\n2,-3");

    expect(result).to.equal(0);
  })

  it("sum should support _ as a delimiters", function () {
    const result = sum("/_\n1\n2_-3_4");

    expect(result).to.equal(4);
  })

  it("sum should support ; as a delimiters", function () {
    const result = sum("/;\n1\n2;-3;4");
